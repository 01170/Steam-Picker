...
this was a fun little project i made while on a call with friends. 
we couldn't decide what to play, and blinding picking one wasn't exciting enough. 
...
# adjust button/display locations here if making your own cabinet skin
CABINET_SIZE = (240, 320)
SCREEN_RECT = (38, 105, 134, 146)   # x, y, w, h - the white cutout
NAME_BAR_RECT = (9, 281, 193, 20)   # x, y, w, h - bottom blue bar
BALL_CENTER = (220, 100)
BALL_HIT_RADIUS = 15
